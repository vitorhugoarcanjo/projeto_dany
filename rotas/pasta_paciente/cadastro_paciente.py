...
def cadastro():
    if request.method == 'POST':
        ...
        try:
            cursor.execute("INSERT INTO pacientes (nome, cpf, telefone) VALUES (?, ?, ?)", (nome, cpf, telefone))
            conn.commit()
            ...
            return render_template('pasta_paciente/cadastro_paciente.html', nome=nome, cpf=cpf, telefone=telefone)

    return render_template('pasta_paciente/cadastro_paciente.html', nome='', cpf='', telefone='')
